...
extern "C" void idt_init(void)
{
	...
	extern int irq14();
	extern int irq15();
	extern int load_idt(unsigned long idt_ptr[2]);
	...
	load_idt(idt_ptr);
	printk("Interrupt Descriptor Table loaded !\n");
}
